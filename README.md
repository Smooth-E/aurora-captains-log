...
| --- |
| 📦 [RuStore для ОС Аврора](https://www.rustore.ru/osaurora) <br> 🛒 [Аврора Маркет](https://aurorarepos.ru/aurora-5/bortovoi-zurnal) <br> 😼 [Скачать RPM](https://github.com/salty-smoothie/aurora-captains-log/releases/latest) |
...
Если у вас есть какие-то вопросы, предложения или вы столкнулись с проблемой при использовании приложения на ОС Аврора, пожалуйста, оставляйте свои комментарии в [трекере GitHub Issues этого репозитория](https://github.com/salty-smoothie/aurora-captains-log/issues).
...
1. Клонируйте этот репозиторий:
   ```sh
   git clone --recurse-submodules https://github.com/salty-smoothie/aurora-captains-log
   ```
...
Этот проект - софт-форк приложения [Бортовой журнал для Sailfish OS](https://codeberg.org/ichthyosaurus/harbour-captains-log). Изменения из астрим-репозитория переодически синхронизируются. Порт основан на ревизии апстрим-репозитория из ветки [main](https://github.com/salty-smoothie/aurora-captains-log/tree/main).
...
Исходный код доступен [на Github](https://github.com/salty-smoothie/aurora-captains-log).
Вся сопутствующая документация распространяется под лицензией 
[GNU Free Documentation License v1.3 (or later)](https://spdx.org/licenses/GFDL-1.3-or-later.html).

- Фото ["Red plant"](https://unsplash.com/photos/red-plant-BclYdfs9N5Y) было использовано при создании баннера и скриншотов.
